 ...
 */
public class BackupIntranetDBJob extends JobWraper implements Job {

    Logger logger = LoggerFactory.getLogger(BackupIntranetDBJob.class);

    @Override
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        String command = this.getScriptRealPath(jobExecutionContext) + "intranetbak.bat";
