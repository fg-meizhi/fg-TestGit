 ...
 */
public class BackupJiraDataJob extends JobWraper implements Job {

    Logger logger = LoggerFactory.getLogger(BackupJiraDataJob.class);

    @Override
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        String command = this.getScriptRealPath(jobExecutionContext) + "JIRA_databak.bat";
